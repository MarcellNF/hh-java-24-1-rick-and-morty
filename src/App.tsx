...
export default function App() {
    const mappedCharacters: Character[] = result.map((character) => {
        return {
            id: character.id,
            name: character.name,
    ...
    const [charcters, setCharacters] = useState<Character[]>(mappedCharacters);
    const [searchText, setSearchText] = useState<string>("");

    const filteredCharacters = charcters.filter((character) => character.name.toLowerCase().includes(searchText.toLowerCase()));
